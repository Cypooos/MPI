...
61. Donnez des automates déterministes sur $\Sigma=\{a,b\}$ reconnaissant $L_1 = \{a^{2n} : n\in\N\}$ et $L_2$ les mots comprenant un nombre pair de $a$ et  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE0NDMxNTc3LDQ2ODczNjI5NywyMTAxND
