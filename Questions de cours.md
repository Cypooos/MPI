...
64. Donnez la méthode de Glush-kov (ou algorithme de Berry-Sethi) pour obtenir l'automate reconnaissant le langage associé à un regexp. Donnez un automate déterministe reconnaissant le langage associé à $(a|b)^*c$
65.  
## Logique
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTg3NDY4NzY0MSw0Njg3MzYyOTcsMjEwMT
