...
Si le code initial est fini (si a partir d'un certain rang $i$, $T$ est nul), alors en posant $x=\underset{0<n<i}{\max}\ T[n]$, on a que $T[j]$ ne pourra jamais dépasser $x$ pour tout $j$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNjEyNzQ5NjYwLC0xNzA5NDc5NDcyLC0xOT
