...
> $$a = M_1^1 \lrarr M_1^2 \lrarr ... \lrarr M_1^{n_1} = M_2^1 \lrarr...\lrarr M_{m-1}^{n_{m-1}} = b$$
 
10. Montrez que $=_\beta$ est une relation d'équivalence sur E.

> On vérifie les axiomes. TODO
...
> On applique alors le théorème de Church Rosser, et on a $\omega\in E$ tel que $e\to^* \omega$ et $e'\to^* \omega$. Comme $e$ et $e'$ sont sous forme normale, on en déduit que $e=\omega=e'$, ce qui conclu l'unicité.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjA1NDY0MjM0OV19
-->