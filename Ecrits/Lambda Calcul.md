...
> Indication : On peut procéder par induction selon la règle obtenue pour avoir $t\triangleright t'$. On pourra aussi montrer que, soient $t,t',e\in E$ et $x,y\in V$, on a $t[x\larr t'][y\larr e] = t[y\larr e][x\larr t'[y\larr e]]$ si $x\ne y$ et $t[x\larr t'][y\larr e] = t[x\larr t'[y\larr e]]$ sinon
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTg2OTY4OTIzNSwxOTEyOTUzMzIzLC0xOD
