...
> On le fait par récurrence. On pose $$P_n : « \forall x \in E, \text{fix}(F)(x) \to^n \alpha \implies\exist n_r,\ \underbrace{F(F(...(F)...))}_{n_r\text{ fois}}(x)\to^*\alpha »$$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTcwMTkzNjE0MCw3MzIwOTUyNjEsLTEwNz
