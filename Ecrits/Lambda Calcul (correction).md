...
> >
> > On utilise donc notre hypothèse de récurrence forte pour $m$, et on a que il existe $n_r^i$ tel que $e_i[f_i\larr F^{n_r^i}](F)(x) \to^* e_{i+1}$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTc3MjQzMDQ3Niw2OTIxNjM0MywtMTc3OD
