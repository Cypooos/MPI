...
> On pose $\text{succ} = (C_n,f,m\mapsto C_n(f,f(m)))$
>
> NB: $\text{succ} = (C_n,f,m\mapsto f(C_n(f,m)))$ ne marche pas ! On aurai $\text{succ}(C_n) = (x\mapsto $
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTc3OTg2ODM3Ml19
-->