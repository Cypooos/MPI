...
> - Initialisation : Soit $x\in E$. Supposons que $\text{fix}(F)(x)\to^2 \alpha$. Alors forcément $\text{fix}(F) \to f(\text{fix}(F))\to \alpha$. Donc $f = x\m$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjU2MDY3NTQzLC03ODkzMDk0MTgsNzMyMD
