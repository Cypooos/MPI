...
> Soit $n\in\N$, on a $\text{eq}(C_n,C_n)\to^* \text{and}\Big(\text{eq\_0}(\text{sub}(C_n,C_n)),\text{eq\_0}(\text{sub}(C_n,C_n))\Big) \to^*\text{and}\Big(\text{eq\_0}(C_0),\text{eq\_0}(C_0)\Big) \to^* \text{and}(\top,\top) \to \top$
> Soit $n<m$, on a 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIwNzExODUwMDMsLTE4NzU4NTIzMTgsLT
QxNTE1OTcxMF19
-->