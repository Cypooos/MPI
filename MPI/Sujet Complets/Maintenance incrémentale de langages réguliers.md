...
## Question 0
Si l’on fixe un langage régulier  $L \sube \Sigma^*$, le problème d’appartenance à $L$ est de déterminer, étant donné en entrée un mot $\omega \in\Sigma^*$, si $\omega \in 8  w  ∈  L. Quelle est la complexité du problème d’appartenance  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTY4ODcyOTU2MV19
-->