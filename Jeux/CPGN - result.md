...
Dans ce cas, on a que, si on appelle $x$ le dernier élément de $t$ (et qu'il est non nul): 
$$
f(t,|t|,|t|-1) \le y(\hat f _ {(x+1)\omega^{|t|}+3} (9)) \le \hat f_{\omega^\omega}(\hat f _ {(x+1)\omega^{|t|}+3} (9)) \le \hat f_{\omega^\omega+1}(9)
$$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1NDQ1MDA4NDEsMTQ4MTk2Mzk4LC0xNz
c3MTk1MDE1LC01MTQwNTE1OTAsNTcwMDIyNTIyLDcwODM4OTMx
MSwtMjY0MTEwMzEsLTQ4MDQwOTI4MiwtMTc0MjI4NTEzMywtOD
